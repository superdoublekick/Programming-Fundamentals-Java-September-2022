...
public class CardsGame {
    public static void main(String[] args) {
        ...
        List<Integer> firstPlayerCards = Arrays.stream((sc.nextLine().split(" "))).map(Integer::parseInt).collect(Collectors.toList());
        List<Integer> secondPlayerCards = Arrays.stream((sc.nextLine().split(" "))).map(Integer::parseInt).collect(Collectors.toList());
